      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-8">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="text-[#002D62] hover:text-[#D7AF6A] transition-colors duration-300 font-medium"
              >
                {link.label}
              </Link>
            ))}
          ...
          <button
            ...
            className="md:hidden text-[#002D62] hover:text-[#D7AF6A] transition-colors"
          >
            ...
            <div className="px-2 pt-2 pb-3 space-y-1">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="block px-3 py-2 text-[#002D62] hover:text-[#D7AF6A] transition-colors duration-300 font-medium"
